...
import 'package:recipe_app/controllers/searchuserrecipe_controller.dart';
...
class ChefProfile extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    final UserRecipeController controller = Get.put(UserRecipeController(userId: user.userId!)); // Pass userId to UserRecipeController
